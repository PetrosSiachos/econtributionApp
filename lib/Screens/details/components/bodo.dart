...
class ItemInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   String text1 , text2;
    ...
    if (ok == "close"){
      text1 = "John";
      text2 = "Η Κάρεν Ρότζερς αποφάσισε να τον φιλοξενήσει προσωρινά αλλά τελικά τον ερωτεύτηκε και τον υιοθέτησε. Τέσσερις μήνες μετά την υιοθεσία ο John είχε μια οικογένεια και ένα «χαμόγελο» μέχρι τα... αυτιά. Βοηθησε τον να συνεχίσει να χαμογελά!!!";
    }
    if (ok == "bear"){
      text1 = "Mike";
    ...
    if (ok == "trash"){
      ...
      text2 = "Ένα δάσος διαφορετικό από τ’ άλλα, που συνθέτει μια τροπική εικόνα, το φοινικόδασος του Βάι βρίσκεται στο ανατολικό άκρο της Κρήτης, στο νομό Λασιθίου.";
    }
